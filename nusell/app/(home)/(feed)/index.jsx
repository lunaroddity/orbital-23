...
export default function HomePage() {
  ...
  const categoryArr = ["All", "Beauty & Personal Care", "Business Services", "Education", 
      "Food & Drinks", "Furniture", "Handicrafts", "Hobbies", "Home Appliances", 
      "Lifestyle Services", "Men's Fashion", "Notes & Cheat Sheets", "Technology", "Women's Fashion"];
